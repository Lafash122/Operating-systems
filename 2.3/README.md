...
Чем больше очередь, тем больше заметно существенное увеличение числа перестановок для потока, выполняющего проверку `!=`, что логично, так как почти всегда у двух соседей длины слов будут неравны.
